$(document).ready(function () {
  function e(e, t, ...a) {
    ...
    if ("object" == typeof t)
      for (let r in t)
        "on" === r.substring(0, 2)
          ? i.addEventListener(r.substring(2).toLowerCase(), t[r])
  ...
  if (window.location.href.indexOf("schedule") > -1) {
    ...
    s.appendChild(c), s.appendChild(n), s.appendChild(h);
  }
      ...
      g = e(
        ...
        e(
          ...
          e(
            "div",
            { class: "card-body" },
            e("h1", { class: "card-title" }, d.title || ""),
            e("h2", { class: "text-muted" }, d.subtitle || ""),
            e("p", { class: "card-text mt-3" }, d.description || t(100)),
            e(
              "a",
  ...
  if (
    ...
    let p = document.getElementById("purchaseBtn"),
      m = document.getElementById("purchaseEmail"),
      b = document.querySelector(".modal-content"),
      f = document.querySelector(".modal-body"),
      y = document.querySelector(".modal-footer");
        ...
        b.append(
          e(
            ...
            e(
              "h5",
              { class: "modal-title" },
              `Thanks for requesting a ticket purchase! We will send an email to ${m.value} to complete the order form!`
            )
          )
        );
    });
